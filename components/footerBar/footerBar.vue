    ...
    <div class="footer-wrapper container">
      ...
      <b-row class="nav-container container">
        ...
        <b-col cols="6" xs="6" sm="3" md="3" xl="3" lg="3">
          <b-img src="https://crust-data.oss-cn-shanghai.aliyuncs.com/crust-home/assets/images/code.png" right width="100"></b-img>
        </b-col>
      </b-row>
...
.footer {
  ...
  .footer-wrapper {
    ...
    .bg-wrapper {
      text-align: center;
      @include bgImage("https://crust-data.oss-cn-shanghai.aliyuncs.com/crust-home/assets/images/footerBg");
      font-size: 14px;
      line-height: 100px;
      margin: 0 auto;
      color: #c5cad5;

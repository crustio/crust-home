...
export default {
  ...
  methods: {
    ...
    handleSwitchswapVideoClick() {
      this.switchswapVideoSource = 'https://crustwebsites.net/ipfs/QmcYfQ6wjb9hop4LhJ9MZrX8GGiJRm6PxBfnVo2JqzEm9V'
      this.showSwitchswapVideo = true
    },
    handleFileVideoClick() {
      this.fileVideoSource = 'https://crustwebsites.net/ipfs/QmWf36uY5E8mLD9nQnVxMEymAMhRh1yJ9th2fqQe1UmLqg'

     ...
     this.modalShow=false
      ...
      if (name === "ecowhitepaper") {
        let economicPaperurl =
          "https://gw.crustfiles.net/ipfs/QmPWKagEqZxkspDK6KPebWQdpG55TDyiNQi5EJ1bRgo4Z7"
        if (!isZh) {
          name += "_en"
          economicPaperurl =
            "https://gw.crustfiles.net/ipfs/QmXUhqUgZGVJsWmV4TCDePwWtpJvEAx7rvNCjuNKaEUHzk"
        }
        return window.open(`${economicPaperurl}`, "_blank")
      }
      if (name === "whitepaper") {
        const url = !isZh
          ? "https://gw.crustfiles.net/ipfs/QmP9WqDYhreSuv5KJWzWVKZXJ4hc7y9fUdwC4u23SmqL6t"
          : "https://gw.crustfiles.net/ipfs/QmPrU21TrRtWcrWsNmHfBmSvTKZApKCEZrDGncnheMGKsj"
      ...
      if (name === "csm lightpaper") {
        // https://gw.crustfiles.net/ipfs/QmdPsqY6W1v5KUYH8Q1m8SCJwFLXSwRJeeeft9WS6ct3JA?filename=LT%20paper.(ZH).1_compressed.pdf
        const url = !isZh

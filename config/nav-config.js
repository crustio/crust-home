const outerDit = {
  ...
  "crust network_zh":
    "https://apps.crust.network/?rpc=wss%3A%2F%2Frpc.crust.network#/explorer",
  "crust wallet": "https://wiki.crust.network/docs/en/crustWallet",
  ...
  download: "https://crust.network/download/",
  ...
  csm_lightpaper_en:
    "https://gw.crustfiles.net/ipfs/QmYVRP7puUhGvQPuThHK2mtQgj2nUAoJYkBgXYxwiaC8Dq?filename=Crust%20Shadow%20lightpaper202105.pdf",
  csm_lightpaper_zh:
    "https://gw.crustfiles.net/ipfs/QmdPsqY6W1v5KUYH8Q1m8SCJwFLXSwRJeeeft9WS6ct3JA?filename=Crust Shadow lightpaper中文版202105.pdf",
  rewards_plan_en:
  ...
  mediamaterials:
    "https://gw.crustfiles.net/ipfs/Qme9uUpunio7heGDnnfsptYWzjLJgvD2hkbLGcvehPz5EK?filename=CrustLogo.zip",
  ...
  analysis_of_economic_model_en:
    "https://gw.crustfiles.net/ipfs/QmPeoZuvhq8G5SQ95KJ35xGVLP3pHtF2hahrtFsjTaZbFk?filename=Analysis of Crust Network Economic Model.pdf",
  analysis_of_economic_model_zh:
    "https://gw.crustfiles.net/ipfs/QmTeYZVYucgF94cU9Bfuew6shWiTESYKYjDFntG9xK5Hru?filename=解析Crust Network经济模型.pdf",
  crust_mainnet: "https://swap.crust.network//#/swap",
  crust_mainnet_zh: "https://swap.crust.network//#/swap",

  Technology_WP:"https://gw.crustfiles.net/ipfs/QmP9WqDYhreSuv5KJWzWVKZXJ4hc7y9fUdwC4u23SmqL6t",
